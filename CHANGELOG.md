...
* (Frames) **Fixed party and arena frames always growing vertically**, whatever the Grow setting said. The layout read a setting that nothing ever wrote, so the dropdown had no effect on those frames — worst after a rebuild coming out of combat.
