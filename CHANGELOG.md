...
### Bug Fixes
* Fix Aura Designer healthbar color mode not working (case sensitivity in dropdown values)
* Fix Aura Designer healthbar tint mode nearly invisible (blend value divided by 100 twice)
* Fix Aura Designer healthbar not reverting to original color when buff expires
* Fix Aura Designer tint mode color drifting when applied multiple times
...
### New Features
* Aura Designer border indicator now supports all highlight styles (Solid, Animated, Dashed, Glow, Corners)
* Aura Designer preview frame now renders border styles live when changing options
