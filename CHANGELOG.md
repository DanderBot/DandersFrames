...
* (Aura Filters) **"Dispellable Debuffs" — which dispels count — moved to the Aura Filters page**, directly under the category it belongs to. It sat on the Debuffs page while both settings that enable it are on Aura Filters, so it was permanently greyed with nothing on that page able to switch it on.
