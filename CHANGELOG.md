...
* (Interface) **New border animation: Blink.** A crisp on/off strobe for an at-a-glance alert, available anywhere DF border animations are — frame borders, Aura Designer indicators, and the Defensive / Missing-Buff icons.
