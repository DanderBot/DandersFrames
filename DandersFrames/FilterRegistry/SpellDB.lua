...
-- WCL harvest v5.5, 2026-09-09 (lab discussion
-- ee16e59f-d4c9-4680-b2ca-17a754a3e102), 15 categories /
-- 609 ids in 430 records.
...
R.Spells = {
    ...
    { id = 428737, alts = { 428735 }, n = "Harmony of the Grove", class = "DRUID", cats = { healing = true } },
    ...
    { id = 1235193, n = "Holy Ray", class = "PRIEST", cats = { healing = true } },
    { id = 383235, n = "Undercurrent", class = "SHAMAN", cats = { healing = true } },
    { id = 1280172, n = "Shadowfiend", class = "PRIEST", cats = { healing = true } },
    ...
    { id = 381732, alts = { 381741, 381746, 381748, 381749, 381750, 381751, 381752, 381753, 381756, 381757, 381758, 381754 }, n = "Blessing of the Bronze", class = "EVOKER", cats = { raidBuffs = true } },
    ...
    { id = 31884, n = "Avenging Wrath", class = "PALADIN", off = true, cats = { raidDefensives = true } },
    ...
    { id = 359816, alts = { 363502, 362361 }, n = "Dream Flight", class = "EVOKER", cats = { raidDefensives = true } },
    ...
    { id = 443028, alts = { 1248992 }, n = "Celestial Conduit", class = "MONK", cats = { raidDefensives = true, offensiveCooldowns = true } },
    ...
    { id = 117679, alts = { 33891 }, n = "Incarnation: Tree of Life", class = "DRUID", cats = { raidDefensives = true } },
    ...
    { id = 375226, alts = { 375252, 375230, 375229, 375257, 375253, 375256, 375240, 375254, 375238, 375234, 375258, 375255 }, n = "Time Spiral", class = "EVOKER", cats = { movement = true } },
    ...
    { id = 276111, alts = { 221886, 221883, 276112, 254474, 254472, 254471, 221885, 254473, 363608, 294133, 221887, 1272854, 453804, 1253874, 1253723, 1253881 }, n = "Divine Steed", class = "PALADIN", cats = { movement = true } },
    ...
    { id = 370889, alts = { 370888 }, n = "Twin Guardian", class = "EVOKER", cats = { movement = true, utility = true } },
    ...
    { id = 427912, alts = { 258920, 427913, 427914 }, n = "Immolation Aura", class = "DEMONHUNTER", off = true, cats = { defensives = true } },
    ...
    { id = 86659, alts = { 393108, 212641 }, n = "Guardian of Ancient Kings", class = "PALADIN", cats = { defensives = true, tankCooldowns = true } },
    ...
    -- ------------------------------------------------------------
    -- Offensive Cooldowns
    -- Burst-window signal rather than a defensive read: 60s+ cooldown,
    -- a real aura, harvest evidence. Flagged exceptions are noted in
    -- the lab thread rather than filtered out here.
    -- ------------------------------------------------------------
    ...
    { id = 370965, alts = { 1246167, 1259431 }, n = "The Hunt", class = "DEMONHUNTER", off = true, cats = { offensiveCooldowns = true } },
    { id = 391528, n = "Convoke the Spirits", class = "DRUID", off = true, cats = { offensiveCooldowns = true } },
    ...
    { id = 202770, n = "Fury of Elune", class = "DRUID", off = true, cats = { offensiveCooldowns = true } },
    { id = 442204, alts = { 403631 }, n = "Breath of Eons", class = "EVOKER", off = true, cats = { offensiveCooldowns = true } },
    { id = 375087, n = "Dragonrage", class = "EVOKER", cats = { offensiveCooldowns = true } },
    { id = 357210, alts = { 433874, 1236943 }, n = "Deep Breath", class = "EVOKER", off = true, cats = { offensiveCooldowns = true } },
    { id = 288613, n = "Trueshot", class = "HUNTER", cats = { offensiveCooldowns = true } },
    { id = 1261193, n = "Boomstick", class = "HUNTER", off = true, cats = { offensiveCooldowns = true } },
    ...
    { id = 51690, alts = { 1248012 }, n = "Killing Spree", class = "ROGUE", cats = { offensiveCooldowns = true } },
    ...
    { id = 191634, n = "Stormkeeper", class = "SHAMAN", off = true, cats = { offensiveCooldowns = true } },
    ...
    { id = 1257052, n = "Dark Harvest", class = "WARLOCK", off = true, cats = { offensiveCooldowns = true } },
    ...
    { id = 1258344, alts = { 1258345 }, n = "Stampede", class = "HUNTER", off = true, cats = { offensiveCooldowns = true } },
    ...
    { id = 204066, n = "Lunar Beam", class = "DRUID", off = true, cats = { offensiveCooldowns = true } },
    { id = 325153, n = "Exploding Keg", class = "MONK", off = true, cats = { offensiveCooldowns = true } },
    { id = 454351, n = "Avenging Wrath", class = "PALADIN", cats = { offensiveCooldowns = true } },
    { id = 186254, alts = { 1235388, 1285912, 19574 }, n = "Bestial Wrath", class = "HUNTER", cats = { offensiveCooldowns = true, petBuffs = true } },
    { id = 1263569, n = "Abomination Limb", class = "DEATHKNIGHT", cats = { offensiveCooldowns = true } },
    { id = 102543, alts = { 252071 }, n = "Incarnation: Avatar of Ashamane", class = "DRUID", cats = { offensiveCooldowns = true } },
    { id = 123904, n = "Invoke Xuen", class = "MONK", cats = { offensiveCooldowns = true } },
    { id = 1253799, n = "Sundering Roar", class = "DRUID", cats = { offensiveCooldowns = true } },
    { id = 417282, n = "Crashing Chaos", class = "WARLOCK", cats = { offensiveCooldowns = true } },
    { id = 1276767, n = "Tyrant's Oblation", class = "WARLOCK", cats = { offensiveCooldowns = true } },
    { id = 266087, n = "Rain of Chaos", class = "WARLOCK", cats = { offensiveCooldowns = true } },
    { id = 1249810, n = "Finish the Job", class = "ROGUE", cats = { offensiveCooldowns = true } },
    { id = 1247908, n = "Splinterstorm", class = "MAGE", cats = { offensiveCooldowns = true } },
    { id = 5217, n = "Tiger's Fury", class = "DRUID", off = true, cats = { offensiveCooldowns = true } },
    ...
    { id = 370553, n = "Tip the Scales", class = "EVOKER", cats = { utility = true } },
    { id = 132158, n = "Nature's Swiftness", class = "DRUID", cats = { utility = true } },
    { id = 378081, n = "Nature's Swiftness", class = "SHAMAN", cats = { utility = true } },
    ...
    { id = 1295885, alts = { 1307470 }, n = "Hex Lord's Doom", class = "ALL", cats = { trinketsItems = true } },
    ...
    { id = 1308013, n = "50-Lb Midnight Salmon", class = "ALL", cats = { trinketsItems = true } },
    { id = 1266182, n = "Bear", class = "ALL", cats = { trinketsItems = true } },
    { id = 1292300, n = "Brittle Torga Totem", class = "ALL", cats = { trinketsItems = true } },
    ...
    { id = 1295582, n = "Focus of Ula'tek", class = "ALL", cats = { trinketsItems = true } },
    ...
    { id = 1308014, n = "Rotting Voidfin", class = "ALL", cats = { trinketsItems = true } },
    { id = 1266403, n = "Sacred Duty", class = "ALL", cats = { trinketsItems = true } },
    { id = 1303479, n = "Sanguine Rancor", class = "ALL", cats = { trinketsItems = true } },
    { id = 1263644, n = "Seed of Radiant Hope", class = "ALL", cats = { trinketsItems = true } },
    { id = 1292299, n = "Seriously Sharp Seashell", class = "ALL", cats = { trinketsItems = true } },
    { id = 1308012, n = "Slick and Slimy Gralstone", class = "ALL", cats = { trinketsItems = true } },
    { id = 1307578, alts = { 1291894 }, n = "Soulcoil Barrier", class = "ALL", cats = { trinketsItems = true } },
    { id = 1306870, n = "Tattered Tortollan Scroll", class = "ALL", cats = { trinketsItems = true } },
    { id = 1295057, n = "Tidal Insight", class = "ALL", cats = { trinketsItems = true } },
    ...
    { id = 1307922, n = "Venomcursed Mastery", class = "ALL", cats = { trinketsItems = true } },
    { id = 1317581, n = "Venomcursed Ascendance", class = "ALL", cats = { trinketsItems = true } },
}
