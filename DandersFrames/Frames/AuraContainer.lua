...
-- again. Standalone 30s ticker on this line (the dev line rides its safety-net sweep);
-- WARNs once per session, secrecy-guarded (a sealed read skips silently and tries the
