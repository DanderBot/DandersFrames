...
L["Channel"] = true
L["Click"] = true
L["Competes for the frame's single border. The highest-priority aura wins and the rest stay hidden."] = true
...
L["Drag"] = true
L["Draws its own border, so it shows at the same time as the others."] = true
...
L["GROUP NAME"] = true
L["GROWTH"] = true
L["Give each stacked border a different Inset so they nest instead of overlapping."] = true
L["Global"] = true
L["HP"] = true
L["Health"] = true
