...
L["Show settings groups in the old inline layout instead of the new popout rows. A temporary aid while the redesign settles in — this option will be removed in a later update."] = true
...
L["Pick the aura first, then choose what it does on the frame."] = true
