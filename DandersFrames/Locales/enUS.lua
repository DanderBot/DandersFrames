...
L["Only during pandemic window"] = true
L["Colors the frame only while the buff is inside its refresh window — the moment when recasting wastes none of the remaining time. The game sets this window per spell, so there is no threshold to choose. Buffs you cannot refresh never have one."] = true
