...
L["Arrow keys move the selected element. Hold Shift for 10 units."] = true
L["Auto"] = true
L["Cancel"] = true
L["Click to select, arrow keys to nudge."] = true
L["Close"] = true
L["Drag to move. Shift locks an axis."] = true
L["Drop into a zone to re-anchor; Detach frees it."] = true
...
L["Discard"] = true
L["Grid Size"] = true
L["Hold Shift for 10 units."] = true
