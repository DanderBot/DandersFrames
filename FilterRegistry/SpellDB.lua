...
R.Spells = {
    ...
    { id = 382024,  n = "Earthliving Weapon",       class = "SHAMAN",  off = true, cats = { healing = true } },
    ...
    { id = 431907,  n = "Sun's Avatar",             class = "PALADIN", off = true, cats = { healing = true } },
    { id = 453846,  n = "Resonant Energy",          class = "PRIEST",  off = true, cats = { healing = true } },
    ...
    { id = 386208,  n = "Defensive Stance",         class = "WARRIOR", off = true, cats = { defensives = true } },
    ...
    { id = 45242,   n = "Focused Will",             class = "PRIEST",  off = true, cats = { defensives = true } },
    ...
    { id = 434107,  n = "Vampiric Aura",            class = "DEATHKNIGHT", off = true, cats = { defensives = true } },
    ...
    { id = 390264,  n = "Commander of the Dead",    class = "DEATHKNIGHT", off = true, cats = { petBuffs = true } },
