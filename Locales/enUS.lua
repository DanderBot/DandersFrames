...
L["Disable While Flying"] = true
L["When enabled, click-casting bindings will be temporarily disabled while you are flying."] = true
L["This includes mounted & druid flight form."] = true
