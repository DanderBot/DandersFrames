...
L["Export"] = true
L["For expiry colour, set the Color Mode in Texture & Colors."] = true
...
L["Build and edit buff filters here, then enable them per row in Aura Filters. Changes you make to built-in presets are saved per profile and survive spell database updates."] = true
L["Built-in Presets"] = true
...
L["You have full control over buffs — enable or disable any spell in the presets below, or create your own custom filters. Debuffs are more limited: Blizzard only lets addons filter them by category (boss, dispellable, crowd control, and so on), not by individual spell, so the debuff filters themselves can't be customised."] = true
