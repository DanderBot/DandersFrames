...
L["Sets the duration-text colors used wherever Color by Time Remaining is enabled (buffs, debuffs, defensives and the Aura Designer). Each stop colors the time remaining from its value upward."] = true
...
L["%d-%ds"] = true
L["under %ds"] = true
L["Set the time colors on the %s page."] = true
L["Color Mode"] = true
