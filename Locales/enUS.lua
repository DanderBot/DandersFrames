...
-- Boss Frames (alphabetical)
L["Above icon"] = true
L["Below icon"] = true
L["Boss Frames"] = true
L["Cast Bar"] = true
L["Configure the boss frames shown on engaged bosses (up to 5). These replace the default Blizzard boss frames."] = true
L["Copy Boss Settings"] = true
L["Copy from %s"] = true
L["Current + Percent"] = true
L["Current"] = true
L["Detached Position"] = true
L["Detached"] = true
L["Filter"] = true
L["Format"] = true
...
L["High Threat"] = true
L["Inside (centered)"] = true
L["Low Threat"] = true
L["Max Count"] = true
L["Overthreat"] = true
L["Placement"] = true
L["Portrait Position"] = true
L["Portrait Size"] = true
L["Portrait"] = true
...
L["Show Threat"] = true
L["Show a colored glow around the frame when the boss targets you or when you are on its threat table."] = true
L["Show buffs or debuffs on each boss frame. Like Blizzard's default boss frames but fully configurable."] = true
L["Static Color"] = true
L["Tanking"] = true
L["Target Me (glow when boss targets player)"] = true
L["Target Me"] = true
L["This will overwrite all Boss Frame settings for the current mode (%s) with the settings from %s mode. Continue?"] = true
L["Threat / Target Indicator"] = true
L["Threat Levels (4 colors by threat situation)"] = true
L["Threat"] = true
L["Timer Text"] = true
L["Unlock Mover"] = true
