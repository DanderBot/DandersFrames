...
L["Aura debug logging toggle"] = true
...
L["Boss debuff / private aura state"] = true
...
L["Defensive bar dedup state dump"] = true
L["Defensives"] = true
L["dev build"] = true
L["Dev tools (alpha/beta builds only)"] = true
L["Direct aura scan state / rescan"] = true
...
L["Edge Glow needs Custom colors. Full Frame is shown instead."] = true
L["Edit"] = true
