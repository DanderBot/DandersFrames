...
L["AFK"] = true
L["AFK Icon"] = true
L["A preset is a saved designer setup, kept under a name."] = true
L["AGGRO"] = true
L["Aggro Flag"] = true
...
L["Editing"] = true
L["Editing:"] = true
L["Editing this preset changes all of them."] = true
L["Ellipsis"] = true
L["Ellipsis (...)"] = true
...
L["Points %s at the preset %s is using, so both share one setup."] = true
L["Poison"] = true
L["Position"] = true
...
L["Use the preset \"%s\" for %s as well, and keep the choice in step?\n\nEditing either mode then changes both. %s's current preset \"%s\" stays in the list and is not deleted."] = true
L["Use the preset \"%s\" for %s as well?\n\nThis shares one setup rather than copying it — editing either mode then changes both. %s's current preset \"%s\" stays in the list."] = true
