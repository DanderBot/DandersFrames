...
L["Show AddOnComparment Button"] = true
...
L["Shows an access button/icon in the Blizzard AddOnCompartment.\nThis is a Blizzard API 10.x+ feature and requires a UI Reload to take effect"] = true
