...
do
    ...
    -- Icon and Text column 2 -- the Buffs page's split. A band has to be BUILT at the
...
--
-- Five of the thirteen, Visibility among them: with Show Debuffs hoisted its pane is one slider, which is the plainest case the inline arm has.
-- ============================================================
print("-- Debuff Bar page: the rows that mount their pane on the plate")
do
    ...
    local BEHIND = { "filterMount", "blMount", "borderMount", "impMount", "durationMount", "stackMount", "dispelMount", "durBarMount" }
