...
WB:RegisterBuiltinWizard({
    ...
    build = function()
        ...
        local directFilterKeys = {
            ...
            "directBuffSortOrder",
            "directDebuffShowAll", "debuffFilterBoss", "debuffFilterRole",
            "debuffFilterPriority", "debuffFilterCrowdControl",
            "debuffFilterRaid", "debuffFilterDispellable",
            "directDebuffDispellableMode", "debuffMaxDurationEnabled",
            ...
            settingsMap = {
                direct_config = {
                    defaults = {
                        ...
                        -- Debuff defaults: the curated 12.1 category set (matches
                        -- the factory defaults in Config.lua). The old advice was
                        -- All Debuffs = true; the categories replaced it.
                        ["party.directDebuffShowAll"] = false,
                        ["party.debuffFilterBoss"] = true,
                        ["party.debuffFilterRole"] = true,
                        ["party.debuffFilterPriority"] = true,
                        ["party.debuffFilterCrowdControl"] = true,
                        ["party.debuffFilterRaid"] = false,
                        ["party.debuffFilterDispellable"] = true,
                        ["party.directDebuffDispellableMode"] = "PLAYER",
                        ["party.debuffMaxDurationEnabled"] = false,
                        ["party.debuffMaxDurationMinutes"] = 5,
                        ["party.debuffMaxDurationKeepImportant"] = true,
                        ["party.directDebuffSortOrder"] = "TIME",
                        -- Same for raid
                        ["raid.directBuffShowAll"] = false,
                        ["raid.directBuffOnlyMine"] = true,
                        ["raid.directBuffSortOrder"] = "TIME",
                        ["raid.directDebuffShowAll"] = false,
                        ["raid.debuffFilterBoss"] = true,
                        ["raid.debuffFilterRole"] = true,
                        ["raid.debuffFilterPriority"] = true,
                        ["raid.debuffFilterCrowdControl"] = true,
                        ["raid.debuffFilterRaid"] = false,
                        ["raid.debuffFilterDispellable"] = true,
                        ["raid.directDebuffDispellableMode"] = "PLAYER",
                        ["raid.debuffMaxDurationEnabled"] = false,
                        ["raid.debuffMaxDurationMinutes"] = 5,
                        ["raid.debuffMaxDurationKeepImportant"] = true,
