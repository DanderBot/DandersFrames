...
# every release.
for TOC_FILE in "DandersFrames/DandersFrames.toc" "DandersFrames_Options/DandersFrames_Options.toc" "DandersMover/DandersMover.toc" "DandersUI/DandersUI.toc"; do
    if [ ! -f "$TOC_FILE" ]; then
